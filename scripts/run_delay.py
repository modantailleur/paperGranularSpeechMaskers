...
log_dir = "../speechConcealerExp/logs_delay/"
speakers_list_pruned = speakers_list[10:]  # all speakers except the first 10

driver_script = "granspeechmask_paper/experiments/delay.py"
...
params = {
    ...
    "cvad": ["ten"],
    "vad_thresh": [0.5],
    "delay": [-50, 0, 50, 100, 150, 200, 250, 300], # in ms
    "nr": ["metricgan"],
    "qc": ["none"],
    "rr": ["none"],
    "fe": ["logmel"],
