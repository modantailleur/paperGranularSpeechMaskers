...
log_dir = "../speechConcealerExp/logs/"
speakers_list_pruned = speakers_list[10:]  # all speakers except the first 10, which are the VAD-threshold validation split

driver_script = "granspeechmask_paper/experiments/monospeaker.py"

start_time = time.time()

base_params_list = []

# NOT NECESSARY IF COMPUTED IN OTHER EXPERIMENTS
params = {
    "plan": ["baseline"],
...
# ======================================================================
n_jobs = min(20, max(1, int(0.80 * os.cpu_count())))
