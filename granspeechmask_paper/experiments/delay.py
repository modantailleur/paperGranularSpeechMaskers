...
exp_name = "SpeechConcealerExpDelay_20260529"
...
class SettingExp(TemplateSettingExp):
    def __init__(self, setting, experiment, dataset_dir, config_dir):
        ...
        delay_ms = self._normalize(getattr(setting, 'delay', None))
        self.delay = delay_ms / 1000 if delay_ms is not None else None
